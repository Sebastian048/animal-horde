...
public class SniperGun1 : MonoBehaviour
{
    ...
    public void Reload () {
        if (reloading == false && totalBullets > 0 && originalMagazineSize - magazineSize != 0) {
            ...
            anim.SetBool("SniperGun1-R", true);
            reloading = true;
    ...
    void FixedUpdate()
    {
        ...
        //transform.position = Vector3.Lerp(startAds.position, endAds.position, adsLocation);  ??????
        ...
        if (adsing == false && shooting == false) {
            ...
            if (comeBack == true) {
                if (bloomNum >= 200) {
                    bloomNum = bloomNum - 25 * Time.deltaTime;
                } else {
                    comeBack = false;
                }
            }
    ...
    public void Ads () {
        ...
        anim.SetBool("SniperGun1-R", false);
    ...
    public void Shoot () {
        ...
        anim.SetBool("SniperGun1-S", true);
        Invoke ("StopShootAnim", 0.5f);
        shooting = true;
        ...
        Invoke ("ShootingFalse", 0.4f);
        }
    }

    public void StopShootAnim () {
        anim.SetBool("isShooting", false);
        anim.SetBool("SniperGun1-S", false);
    }
